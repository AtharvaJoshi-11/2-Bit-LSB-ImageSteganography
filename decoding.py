...
decoded_text = railfence_cipher.decryptRailFence(decoded_text, 5)

decoded_text = caesar_cipher.decipher(decoded_text)

print('Hiddeen Text:',decoded_text)
